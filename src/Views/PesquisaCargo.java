...
public class PesquisaCargo extends javax.swing.JDialog {
    ...
    private void TabelaCargosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaCargosMouseClicked
       ...
       ClasseMembros.IdMembro = Integer.parseInt(TabelaCargos.getValueAt(linha,0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaCargo dialog = new PesquisaCargo(new javax.swing.JFrame(), true);
