...
public class ClasseRotas {
    ...
    private String RTIgrejas = "SELECT id_igreja, nomeigreja, telefone,pastorresponsavel ,email  FROM public.igrejas";
    ...
    private String RTNovoConvertido = "SELECT id_novoconverido, nomeconvertido, endereco, bairro, numero, cidade, uf, dataconversao, obs, telefone, cep\n" +
                                    "	FROM public.novoconvertido";
    
    private String RTCargo = "SELECT idcargo, descricao	FROM public.cargo";
    
    private String RTTipo = "SELECT idtipo, descricao, pconta FROM public.tipo ORDER BY IDTipo Desc";
