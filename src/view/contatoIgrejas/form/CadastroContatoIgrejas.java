...
public class CadastroContatoIgrejas extends javax.swing.JDialog {
    ...
    IgrejaController igrejaController = new IgrejaController();
    ...
    private void Salvar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Salvar1ActionPerformed
        ...
        igrejas.setNomeIgreja(CamoNomeIgreja.getText());
        igrejas.setTelefone(CampoTelefone.getText());
        igrejas.setEndereco(CampoEndereco.getText());
        igrejas.setBairro(CampoBairro.getText());
        igrejas.setEstado(CampoEstado.getSelectedItem().toString());
        igrejas.setCidade(CampoCidade.getText());
        igrejas.setPastorResponsavel(CampopastorResponsavel.getText());
        igrejas.setEmail(CampoEmail.getText());
        igrejas.setCep(CampoCep.getText());
        igrejas.setNumero((CampoNumero.getText().equals("") ? 0 : Integer.parseInt(CampoNumero.getText())));

        verificar(igrejas);

        if(CampoCodigo.getText().equals("")){

            igrejaController.onInsert(igrejas);
            limparcampos();
        }
        else{
            igrejaController.onUpdate(igrejas);
            limparcampos();
            this.dispose();
       }
    ...
    public void verificar(Igrejas igreja){
        if(!CampoCodigo.getText().equals("")){
            igreja.setIdIgreja(Integer.parseInt(CampoCodigo.getText()));
        }
    }
