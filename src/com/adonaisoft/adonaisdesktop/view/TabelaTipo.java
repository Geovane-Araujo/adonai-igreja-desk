...
public class TabelaTipo extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tabelaCargo.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaCargo.getColumnModel().getColumn(0).setPreferredWidth(20);
    ...
    private void BotaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoEditarActionPerformed
       if(CampoCodigo.getText().equals("")){
           ...
           ClasseTipo.IDTipo = Integer.parseInt(CampoCodigo.getText());
           Tipos = 1;
           Cadastrotipo chamar = new Cadastrotipo(null, true);
           String sql = "SELECT * FROM Tipo WHERE IdTipo = "+ClasseCargo.IDCargo;
           chamar.Povoar(sql);
           chamar.setVisible(true);
           String sq = rota.getRTTipo();
           Povoar(sq);
       }
