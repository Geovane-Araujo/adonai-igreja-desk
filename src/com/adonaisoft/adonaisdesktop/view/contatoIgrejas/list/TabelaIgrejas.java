...
public class TabelaIgrejas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        BotaoImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/adonaisoft/adonaisdesktop/Imagens/icons8_Envelope_26px.png"))); // NOI18N
        ...
        Adicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/adonaisoft/adonaisdesktop/Imagens/icons8_Plus_Math_26px.png"))); // NOI18N
        ...
        Excluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/adonaisoft/adonaisdesktop/Imagens/Excluir.png"))); // NOI18N
    ...
    private void BotaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoEditarActionPerformed
        if(CampoCodigo.getText().equals("")){
            ...
            ad.onPovoar(Integer.parseInt(CampoCodigo.getText()));
            ad.setVisible(true);
    ...
    private void TabelaIgrejaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaIgrejaMouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            chamar.onPovoar(Integer.parseInt(CampoCodigo.getText()));
    ...
    private void ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirActionPerformed
        if(CampoCodigo.getText().equals("")){
            ...
            switch(showConfirmDialog(null, "Deseja Realmente Excluir?","Confirma Exclusão",JOptionPane.YES_NO_OPTION)){
                ...
                case 0:
                    Igrejas ex = new Igrejas();
                    igrejaController.onDelete(Integer.parseInt(CampoCodigo.getText()));
                    String sql = rota.getRTIgrejas();
                    preencher(sql);
                break;
