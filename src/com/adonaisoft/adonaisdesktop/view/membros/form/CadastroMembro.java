...
public class CadastroMembro extends javax.swing.JDialog {
    ...
    private void BotaoImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoImprimirActionPerformed
        ...
        try {
            imprimir.carteiraMembro(Integer.parseInt(CampoCodigo.getText()));
            this.dispose();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        if(CampoCodigo.getText().equals("") || CampoCodigo.getText().equals("0")){
            ImageIcon ico = new ImageIcon(path);
            ico.setImage(ico.getImage().getScaledInstance(labelImagem.getWidth(),labelImagem.getHeight(),1));
            labelImagem.setIcon(ico);
            ...
            povoar(Integer.parseInt(CampoCodigo.getText()));
        }
    ...
    public void salvar(){
        ...
        membros.setNome(CampoNome.getText());
        membros.setDataNascimento((java.sql.Date)dt.DataBd(CampoDtNasc.getDate()));
        membros.setTelefone(CampoTelefone.getText());
        membros.setEndereco(CampoEndereco.getText());
        membros.setBairro(CampoBairro.getText());
        membros.setUf(CampoEstado.getSelectedItem().toString());
        membros.setCidade(CampoCidade.getText());
        membros.setObservacoes(CampoObservacoes.getText());
        membros.setDataBatismo(CampoDataBatismo.getText());
        membros.setAtivo(CampoAtivo.isSelected());
        membros.setEmail(CampoEmail.getText());
        membros.setEstadoCivil(CampoEstadoCivil.getSelectedItem().toString());
        membros.setCep(CampoCep.getText());
        membros.setBatizado(CampoBatizado.isSelected());

        if(img == true){

            membros.setImagem(gravarbd.getImgBytes(imagem));
        }
        else{
            membros.setImagem(null);
        }
        ...
        if(CampoCodigo.getText().equals("") || CampoCodigo.getText().equals("0") ){
            membrosController.onInsert(membros);
            limparcampos();

        }
        else{
            Membros editar = new Membros();
            membrosController.onUpdate(membros);
            this.dispose();
       }
    }
    
    public void povoar(int id){
        ...
        try{
            ...
            membros.setImagem(rs.getBytes("imagem"));
            gravarbd.exibiImagemLabel(membros.getImagem(), labelImagem);
            ...
            membros.setIdCargo(Integer.parseInt(rs.getString("IDCargo")));
            rs.close();
            stmt.close();
        }
    ...
    public void verificar(){
        ...
        if(!CampoNumero.getText().equals("")) {
            membros.setId(Integer.parseInt(CampoNumero.getText()));
        }
    }
