...
public class TabelaMembros extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Adicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/adonaisoft/adonaisdesktop/Imagens/AdicionarMembro.png"))); // NOI18N
    ...
    private void BotaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoEditarActionPerformed
        if(CampoCodigo.getText().equals("")){
            ...
            chamar.povoar(Integer.parseInt(CampoCodigo.getText()));
    ...
    private void AdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarActionPerformed
        // usado para validar, se é 0 é um novo diferente de 0 é um Edi
    ...
    private void ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirActionPerformed
        if(CampoCodigo.getText().equals("")){
            ...
            switch(showConfirmDialog(null, "Deseja Realmente Excluir?","Confirma Exclusão",JOptionPane.YES_NO_OPTION)){
                ...
                case 0:
                    membrosController.onDelete(Integer.parseInt(CampoCodigo.getText()));
                    mimx();
                    paginacao();
                break;
